  ...
  return (
    <div className="space-y-4">
      <div className="rise">
        ...
        {lowLiq && (
          <p className="m-0 mt-1 text-[13px]" style={{ color: "var(--warn)" }}>
      ...
      <div className="grid grid-cols-2 gap-2.5 sm:grid-cols-4">
        <StatCard label="등록 평균가">{fmtGold(last?.avgPrice)}{last?.avgPrice != null && <span className="text-[13px] font-normal"> 골드</span>}</StatCard>
